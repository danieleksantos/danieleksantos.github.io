  ...
  const contactMethods = [
    {
      ...
      link: 'mailto:danieleksantos@gmail.com',
      color: '#EA4335',
    },
    {
      icon: (
      ...
      link: 'https://www.linkedin.com/in/danieleksantos/',
      color: '#0A66C2',
    },
    {
      icon: (
      ...
      label: 'GitHub',
      value: '/danieleksantos',
      link: 'https://github.com/danieleksantos',
      color: '#181717',
    },
    {
      icon: (
      ...
      label: 'WhatsApp',
      value: '+55 19 98203-8845',
      link: 'https://wa.me/5519982038845',
      color: '#25D366',
    },
  ]
          ...
          {contactMethods.map((method, index) => (
            ...
            >
              ...
              <div className="contact-card__content">
                <h3 className="contact-card__label">{method.label}</h3>
      ...
      <footer className="footer">
        <div className="footer__content">
          <p className="footer__text">
            © 2026 Daniele Karina dos Santos. Desenvolvido com React.
          </p>
