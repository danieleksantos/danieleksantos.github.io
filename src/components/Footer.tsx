    ...
    <footer className="py-12 px-4 border-t border-purple-200 dark:border-purple-500 bg-gray-100 dark:bg-gray-950 transition-colors duration-500">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
        <div className="text-center md:text-left space-y-2">
          <p className="text-gray-900 dark:text-white font-black tracking-tighter text-xl">
        ...
        <div className="flex flex-wrap justify-center gap-3 text-[10px] uppercase tracking-[0.4em] font-bold text-purple-600/50 dark:text-gray-500">
          <span>Iterate</span>
          <span
        ...
        <button
          onClick={scrollToTop}
          className="group flex items-center gap-4 text-[10px] font-black tracking-[0.2em] text-gray-400 hover:text-purple-600 dark:hover:text-purple-400 transition-all uppercase cursor-pointer focus-visible:outline-2 focus-visible:outline-purple-600 rounded-lg p-2"
